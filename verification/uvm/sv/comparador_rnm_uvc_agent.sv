...
function void comparador_rnm_uvc_agent::connect_phase(uvm_phase phase);
  if (m_config.is_active == UVM_ACTIVE) begin
    //Conecta el puerto de secuencia del driver al puerto de secuencia del sequencer
    m_driver.seq_item_port.connect(m_sequencer.seq_item_export);
  end
  //Conecta el puerto de analisis del monitor al puerto de analisis del agente
